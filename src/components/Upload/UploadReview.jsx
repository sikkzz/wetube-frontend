      ...
      <wt-upload-review>
        ...
        <div className="left-col wt-upload-review">
          <div id="visibility-container" className="wt-upload-review">
            ...
            >
              <div id="first-container" className="wt-video-visibility-select">
                <wt-radio-button
                ...
                >
                  ...
                  <div className="instant-premiere-container wt-video-visibility-select">
                    ...
                    <wt-icon-tooltip compact class="wt-video-visibility-select">
                      <wt-iron-icon id="icon" class="wt-icon-tooltip" compact>
                        <Icons.AiOutlineQuestionCircle size={20} color="#aaa" />
                      </wt-iron-icon>
                    </wt-icon-tooltip>
                  </div>
                </wt-radio-group>
              </div>
              <div id="second-container" className="wt-video-visibility-select">
                <wt-radio-button
                ...
                <p className="visibility-description wt-video-visibility-select">
                  동영상을 <b className="wt-visibility-select">공개</b>로 설정할
                  날짜를 선택합니다.
                </p>
              </div>
            </wt-video-visibility-select>
