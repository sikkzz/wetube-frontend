      ...
      <wt-upload-check>
        <div className="top-row wt-upload-check">
          ...
          <div className="description wt-upload-check">
            ...
            검사합니다. 그러면 동영상을 게시하기 전에 문제를 해결할 수 있습니다.{" "}
            <a href="#!">자세히 알아보기</a>
          </div>
        </div>
        <div className="status-container wt-upload-check">
                ...
                <div id="content-wrapper" className="wt-upload-check-status">
                    <div id="content" className="wt-upload-check-status">
                        <div id="status" className="wt-upload-check-status">
                            ...
                            <div id="icon-and-description" className="wt-upload-check-status">
                                <div id="results-container" className="wt-upload-check-status">
                                    <span id="results-description" className="wt-upload-check-status">발견된 문제가 없습니다.</span>
                                </div>
                            </div>
                        </div>
                        <div id="action" className="wt-upload-check-status">
                            <wt-iron-icon id="success-icon" class="wt-upload-check-status">
            ...
            주의: 검사 결과는 확정적이지 않습니다. 동영상에 영향을 미치는 문제가 나중에 발생할 수도 있습니다.<a href="#!">자세히 알아보기</a>
            </div>
        </div>
        <wt-send-feedback-button class="wt-upload-check">
            <button className="remove-default-style wt-upload-check">
                <div className="feedback-text wt-upload-check">
                    의견 보내기
                </div>
            </button>
